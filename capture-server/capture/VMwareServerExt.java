...
public class VMwareServerExt {
    ...
    private native int nConnect(String address, int port, String username, String password);

    private native int nRevertVM(String vmPath);

    private native int nDisconnect();

    private native int nRunProgramInGuest(String vmPath, String guestUsername, String guestPassword, String guestCmd, String guestCmdOptions);

    private native int nWaitForToolsInGuest(String vmPath, int timeoutSeconds);
